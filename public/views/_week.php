    ...
    <div class="panel-heading">
        <h4 class="panel-title">
            <a data-toggle="collapse" data-parent="#accordion" href="#collapse<?php echo $week["weekId"]; ?>">
                <?php echo $week["weekName"]; ?> <span class="badge pull-right"><?php echo count($week["blogs"]); ?>
            </a>
        </h4>
    </div>
        ...
        <div class="panel-body">
            <?php
                ...
                foreach ($sideBlogs as $sideBlog) {
                    ?>
            <p>
                <a href="<?php echo Util::getHost(); ?>/public/blog/<?php echo $sideBlog["slug"]; ?>"><?php echo $sideBlog["title"]; ?></a>
            </p>
                    <?php
                }
            ?>
