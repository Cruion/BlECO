...
{ ?>
            ...
            <form class="form-horizontal" action="<?php echo Util::getHost(); ?>/blog/<?php echo $blog["slug"]; ?>/edit" method="post">
                <fieldset>
                    <div class="form-group">
                        <label for="title" class="col-sm-2 control-label">Title</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="title" name="title" placeholder="Title" value="<?php echo $blog["title"]; ?>" onkeyup="titleChange()" onchange="titleChange()">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="slug" class="col-sm-2 control-label">Slug</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="slug" name="slug" placeholder="Slug" value="<?php echo $blog["slug"]; ?>" readonly>
                        </div>
                    </div>
                    <div class="form-group">
    ...
    <div class="panel-body">
        ...
        ?>
       <p id = "previewBody"><?php echo UTil::bbCode(nl2br(htmlspecialchars($blog["body"]))); ?></p>
    </div>
</div>
        </div>
